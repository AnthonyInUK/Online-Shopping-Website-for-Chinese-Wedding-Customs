...
export class CheckoutComponent implements OnInit {
  ...
  onSubmit() {
    ...
    */
    ...
    // 安全处理state和country对象
    if (purchase.shippingAddress.state && typeof purchase.shippingAddress.state === 'object') {
      const shippingState: State = JSON.parse(JSON.stringify(purchase.shippingAddress.state));
      purchase.shippingAddress.state = shippingState.name;
    }
    
    if (purchase.shippingAddress.country && typeof purchase.shippingAddress.country === 'object') {
    ...
    // 安全处理billing address的state和country对象
    if (purchase.billingAddress.state && typeof purchase.billingAddress.state === 'object') {
      const billingState: State = JSON.parse(JSON.stringify(purchase.billingAddress.state));
      purchase.billingAddress.state = billingState.name;
    }
    
    if (purchase.billingAddress.country && typeof purchase.billingAddress.country === 'object') {
